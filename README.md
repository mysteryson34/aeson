# # ********aeson******** : 
   ...
   ***built atop Debian (amd64) and/or Raspbian (armhf)***
...
Running **visudo** will open up nano. NOTICE the differences in your own visudo config and the one provided in the example below (specifically, under the line that says *Allow members of group sudo to execute any command*). You should modify your version so that it matches mine. Also note that *you should replace **username** with your own username*.
